...
insert into author(id, name, email, profile_image) values(9, 'abc', 'abe2@naver.com', LOAD_FILE('c:\\samgyeopsal.png'));
...
-- enum에서 지정되지 않은 값을 insert -> error발생
insert into author(id, name, email, role) values(12, 'ddd', 'ddd2@naver.com', 'super-admin');
-- role을 지정하지 않고 insert
insert into author(id, name, email) values(13, 'ddd', 'ddd3@naver.com');

--date(연월일)와 datetime(연월일,시분초)
...
--실습 : 2025년 11월 1일부터 11월19일까지의 데이터를 조회(날짜 뒤에 00:00:00)
