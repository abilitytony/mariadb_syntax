...
-- 실습1. author 테이블에 address 컬럼을 추가(varchar(255)). name은 not null로 변경.
alter table author add column aaddress varchar(255);
alter table author modify column name varchar(255) not null;

-- 실습2. post 테이블에 tilte을 not null로 변경. content는 contents로 이름 변경.
