# window에서는 redis가 직접 설치 안됨 -> 도커를 통한 redis 설치
...
# redis는 0~15번까지의 db로 구성9(default 0번)
# db번호 선택
select db번호
...
# redis String 자료구조 실전활요
# 사례1: 좋아요 기능구현 -> 동시성이슈 해결
